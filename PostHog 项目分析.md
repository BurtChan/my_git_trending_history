...
**最新动态**：
PostHog 在 2026 年 7 月持续扩展其作为「开发者产品操作系统」的定位。平台已从单一分析工具演进为集成产品分析、Web 分析、会话回放、错误追踪、功能标记、实验、调查、数据仓库、CDP 和 AI 产品助手的全栈产品。2026 年初正式弃用 Kubernetes 自托管方案，简化部署架构。Array 1.43.0 版本带来了大规模性能提升，1.41.0 版本性能提升最高达 400%。新增 Notebooks 功能，将文档编写能力直接嵌入分析工作流。社区反馈显示 PostHog 正在成为早期创业团队替代 Mixpanel、Amplitude、FullStory 等付费工具的首选方案。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 36,333 | 36,333 | +0 |
| 总 Forks | 3,013 | 3,013 | +0 |

**核心变化概要**：
- 产品定位从分析工具升级为「开发者产品操作系统」
- 正式弃用 Kubernetes 自托管，简化部署
- Array 1.43.0 带来大规模性能改进
- 新增 Notebooks 文档功能嵌入分析工作流
- Stars 从约 36,000 增长至 36,333，开源替代方案地位巩固
---
