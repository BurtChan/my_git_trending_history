...
### 更新 1 — 2026年9月16日（时隔两年再登 Trending）

**更新原因**：项目时隔两年再次登上 GitHub Trending 榜单，Star 数从 60,671 增长至 68,165（+7,494），Fork 数从 6,240 增长至 7,372（+1,132）。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 60,671 | 68,165 | +7,494 |
| 总 Forks | 6,240 | 7,372 | +1,132 |

- Star 数 60,671 → 68,165（+7,494），稳居开源 AI 编程智能体第一梯队
- VS Code/JetBrains 插件形态 + 任意模型（BYOK）+ Plan & Act 双模式 + MCP + 浏览器自动化的核心竞争力持续兑现
- Apache 2.0 开源，与 Claude Code、Cursor、Copilot 继续正面竞争

> 更新依据：GitHub Trending 2026-09-16 数据，Star 数由 GitHub API 实时获取


### 更新 2 — 2026年9月18日（再次登上 Trending）

**更新原因**：登上 GitHub Trending（2026 年 9 月 18 日），开源 AI 编程智能体热度延续。

**最新 Star 数据**：

| 总 Stars | 68,165 | 68,532 | +367 |
| 总 Forks | 7,372 | 7,413 | +41 |

- Star 数 68,165 → 68,532（+367），9/17 短暂离榜后今日回榜
- SDK + IDE 扩展 + CLI 三形态的自主编程智能体路线持续推进，仓库 9/17 有推送
...
*首次分析：2026 年 4 月 | 最近更新：2026 年 9 月 18 日*
