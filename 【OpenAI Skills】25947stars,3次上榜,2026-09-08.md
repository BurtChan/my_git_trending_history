...
**原因：同日再度上榜（早间首登后持续吸星），单日累计 +240 stars。**


**最新动态**：
- 该仓库已标注 deprecated，Codex 技能与插件示例正式迁移至 openai/plugins 仓库，但社区关注热度不减反增
- 半日内 Star 从 25,548 增至 25,788（+240），Forks 增至 1,736
- Agent Skills 赛道整体持续发酵，官方起点仓库的「生态考古」价值被持续挖掘

**核心变化概要**：
- 单日累计 +240 stars，deprecated 状态下仍保持高吸星速度
- Forks +10，生态迁移讨论带动示例代码引用
- 仓库本身代码冻结，热度完全由 Agent Skills 生态话题驱动

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 25,548 | 25,788 | +240 |
| 总 Forks | 1,726 | 1,736 | +10 |

---

### 更新 2 — 2026 年 9 月 8 日（连续第三日在榜（streak 特例更新））
**原因：连续第 3 天出现在 Trending（9/6-9/8），虽单日 +159 未达 500 阈值，按连续在榜特例更新。**


**最新动态**：
- Star 数从 25,788 增至 25,947（+159），Forks 从 1,736 增至 1,745（+9）
- 仓库维持 deprecated 状态（技能与插件示例已迁移至 openai/plugins），但「生态起点」的考古与引用价值使其连续 3 日在榜
- Agent Skills 赛道整体热度不减，官方规范仓库的示范效应仍在持续引流

**核心变化概要**：
- 连续 3 日在榜（9/6、9/7、9/8），deprecated 仓库的持续吸星能力罕见
- 单日 +159 stars，增速较昨日（+240）有所回落但仍稳定
- 代码冻结状态下热度完全由生态话题驱动
...
| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 25,788 | 25,947 | +159 |
| 总 Forks | 1,736 | 1,745 | +9 |
