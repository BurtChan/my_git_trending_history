...
**更新原因**：项目再次登上 GitHub Trending 榜单，Star 数从 115,494 增长至 116,122（+628），日增 1,138 颗 Star

**最新动态**：
- Star 数突破 116,000 大关，连续 6 天登上 Trending，持续保持 GitHub 最热门 AI 学习资源地位
- 微软 Reactor 推出 Java Edition 系列直播活动（8月18日起），扩展课程语言覆盖面
- 课程持续更新 Foundry Models 平台支持（取代即将退役的 GitHub Models），涵盖 RAG、向量数据库、AI Agents 等前沿主题

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 115,494 | 116,122 | +628 |
| 总 Forks | 61,535 | 61,578 | +43 |

**核心变化概要**：
- Star 数增长 +628，日增 1,138 颗（Trending）。微软出品的生成式 AI 入门旗舰课程，21 节课 + 双语言代码示例 + 60+ 语言翻译
