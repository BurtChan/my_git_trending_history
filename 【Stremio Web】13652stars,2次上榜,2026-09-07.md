...
**原因：同日再度上榜（早间首登后持续吸星），单日累计 +271 stars。**


**最新动态**：
- 仓库当日有新提交（pushed_at 2026-09-07），Web 端持续迭代
- 半日内 Star 从 13,381 增至 13,652（+271），Forks 增至 1,550
- 开源流媒体聚合赛道关注度回升，addon 生态架构被前端社区重新讨论

**核心变化概要**：
- 单日累计 +271 stars，三个候选中增速最快
- Forks +9，社区试用与二开意愿同步上升
- 当日活跃提交，媒体中心赛道热度与项目迭代同频

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 13,381 | 13,652 | +271 |
| 总 Forks | 1,541 | 1,550 | +9 |
