...
### 更新 6 — 2026 年 8 月 23 日（再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：
- Star 数 4,518 → 4,606（+88），第 6 次登上 Trending
- Forks 352 → 378（+26），官方插件示例库被越来越多开发者 fork 改造
- 随 Cursor 插件生态扩张，仓库持续作为官方参考实现

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 4,518 | 4,606 | +88 |
| 总 Forks | 352 | 378 | +26 |
...
### 更新 7 — 2026 年 8 月 28 日（再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单，时隔 5 天重返榜单

**最新 Star 数据**：

| 总 Stars | 4,606 | 5,830 | +1,224 |
| 总 Forks | 378 | 473 | +95 |

**核心变化概要**：
- Star 数 4,606 → 5,830（+1,224），第 7 次登上 Trending
- Forks 378 → 473（+95），插件生态持续吸引开发者参与
- 仓库 8 月 27 日仍有推送，插件规范与官方插件持续演进


---

### 更新 8 — 2026 年 8 月 29 日（再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单

**最新 Star 数据**：

| 总 Stars | 5,830 | 6,059 | +229 |
| 总 Forks | 473 | 481 | +8 |

**核心变化概要**：
- Star 数 5,830 → 6,059（+229），第 8 次登上 Trending
- Forks 473 → 481（+8），生态关注度稳步提升
