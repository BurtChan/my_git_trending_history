...
**最新动态**：OpenClaude 连续第四日登上 Trending，单日 +458 星，总星数达到 3.23 万。「Claude Code 开源替代」赛道关注度持续升温，其「runs anywhere, uses anything」的开放定位（可接入任意模型端点）持续吸引寻求供应商解绑的开发者，Forks 增至 9,018 表明二次开发与集成活跃度高。

**最新 Star 数据**：

| 总 Stars | 31,826 | 32,284 | +458 |
| 总 Forks | 8,945 | 9,018 | +73 |

**核心变化概要**：
- Star 数 31,826 → 32,284（+458），连续第 4 日在榜
- Forks 8,945 → 9,018（+73），突破 9,000
- 开源替代赛道热度持续，增长动能平稳
- 开放端点定位吸引供应商解绑需求开发者
