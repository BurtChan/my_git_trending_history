...
### 更新 5 — 2026 年 9 月 16 日（连续第五天在榜）

**更新原因**：连续第五日在榜，早期项目持续积累。

**最新动态**：
- Stars 2,616 → 2,729（+113），连续五天在榜累计 +1,686（1,043 → 2,729）
- Forks 656 → 672（+16），自托管部署需求持续增强
- 开放 Issue 130 → 107 区间波动，社区响应速度加快

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|---|---|---|---|
| 总 Stars | 2,616 | 2,729 | +113 |
| 总 Forks | 656 | 672 | +16 |
| 今日新增 | — | +113 | — |
**核心变化概要**：
- Stars 2,616 → 2,729（+113），连续五天在榜累计 +1,686（1,043 → 2,729）
