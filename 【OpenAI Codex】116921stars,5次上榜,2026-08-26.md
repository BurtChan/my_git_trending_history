...
### 更新 4 — 2026 年 8 月 26 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：OpenAI Codex 连续第四日在榜，Star 单日 +1,011（116,921 → 117,932），Fork 增至 17,981（+157）。作为 OpenAI 官方终端编码智能体，其 Apache-2.0 真开源 + ChatGPT 订阅直连的模式持续吸引开发者迁移，与 Claude 系插件的生态竞争（本周 anthropics/claude-plugins-community 同步上榜）成为 AI 编码赛道的主线叙事。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 116,921 | 117,932 | +1,011 |
| 总 Forks | 17,824 | 17,981 | +157 |

**核心变化概要**：
- Star 单日 +1,011，逼近 11.8 万
- Fork 增至 17,981，日均 +150 上下
- 与 Claude 插件生态正面竞争成为赛道主线
