...
### 更新 1 — 2026 年 9 月 7 日（时隔近 5 个月再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单。

**最新动态**：MarkItDown 自 2026 年 4 月分析以来继续稳居「文档转 Markdown」赛道头名，Star 数从 105,638 增长至 179,341（+73,703，接近翻倍）。作为微软 AutoGen 团队维护的文档转换工具，它已被广泛集成进各类 LLM 应用与 RAG 管线的文档预处理环节，MCP 支持与插件生态持续完善。今日上榜（+771 stars）显示其在 AI 应用基础设施中的地位依然稳固。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Star 数 | 105,638 | 179,341 | +73,703 |
| 总 Forks | — | 13,217 | — |

**核心变化概要**：
- Star 数从 10.5 万增至 17.9 万（+73,703），文档转换赛道头部地位稳固
- 已成为 RAG/LLM 应用文档预处理的事实标准组件之一
- 插件系统与 MCP 集成持续完善，生态覆盖面扩大
- 微软官方维护的长期可信赖度是核心护城河
...
**原因：连续第二天上榜，单日 +559 stars，文档转 Markdown 基础设施地位稳固。**


**最新动态**：
- Star 数从 179,341 增至 179,900（+559），Forks 从 13,217 增至 13,250（+33）
- 距离 18 万 Star 里程碑仅差约 100，即将成为微软开源家族中又一个 180K 级项目
- RAG 与 Agent 文档预处理管线的默认选型地位持续巩固，MCP 集成与插件生态稳步扩张

**核心变化概要**：
- 单日 +559 stars，日均增速保持在高位区间
- Forks +33，集成类二次开发活跃
- 主表中 Fork 数（6,625）为 4 月快照，本次同步刷新至 13,250

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 179,341 | 179,900 | +559 |
| 总 Forks | 13,217 | 13,250 | +33 |
...
**更新原因**：连续第三日登上 Trending，Star 179,900 → 181,430（+1,530，API 口径）

**最新动态**：
- Star 数从 179,900 增至 181,430（+1,530），日增较昨日（+559）明显放大，Trending 页面单日增量 +2,045
- Forks 从 13,250 增至 13,326（+76），集成类二次开发持续活跃
- 文档转 Markdown 需求随 LLM 数据流水线普及稳定增长，MarkItDown 保持该赛道 Star 数第一

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 179,900 | 181,430 | +1,530 |
| 总 Forks | 13,250 | 13,326 | +76 |

**核心变化概要**：
- Star 增长 1,530，连续第三日在榜且涨速回升
- 累计突破 18.1 万 Star，文档转换工具头部地位稳固
- Forks 稳定增长，企业集成场景持续扩展
...
*数据来源：GitHub 仓库 (microsoft/markitdown)，2026 年 9 月 7 日访问*
