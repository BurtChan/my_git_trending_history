...
### 更新 2 — 2026 年 9 月 8 日（连续第 2 日登上 Trending）

**更新原因**：连续第 2 日登上 Trending（SnailDev 9/7 起在榜），Star 47,342 → 47,941（+599，API 口径）

**最新动态**：
- Marketing Skills 连续第二日在榜，Star 从 47,342 增长至 47,941（+599），Forks 从 7,379 增至 7,417（+38），昨日翻倍增长的动能仍在延续。
- 据 skills.sh 目录统计，该库以 281.9K 累计安装量居营销类技能榜首（49 个技能）；生态侧出现 mysticaltech 等预构建 .skill 文件的 fork 分发版本，插件市场 / SkillKit / npx skills add 等多渠道安装路径进一步降低采用门槛。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 47,342 | 47,941 | +599 |
| 总 Forks | 7,379 | 7,417 | +38 |

**核心变化概要**：
- 连续第 2 日在榜，Star 47,342 → 47,941（+599），营销技能赛道热度延续
- Forks 7,379 → 7,417（+38），安装量 281.9K 居 skills.sh 营销类榜首
- 生态衍生：预构建 fork、plugin marketplace、SkillKit 多渠道分发成型

---

### 更新 3 — 2026 年 9 月 9 日（连续第 3 日登上 Trending）

**更新原因**：Star 单日增长 +743，连续第 3 日在榜，增速较昨日（+599）继续加快。

**最新动态**：Marketing Skills 连续第三日在榜，Star 从 47,941 增长至 48,684（+743），Forks 从 7,417 增至 7,486（+69）。作为覆盖 CRO、SEO/AI-SEO、付费广告、留存、Growth Engineering、RevOps 等营销全链路的 40+ 技能库，随着 Agent Skills 生态（Claude Code / Codex / 插件市场）安装渠道的普及，其在营销科技人群中的采用率持续攀升，本周已稳定保持日均 +500 以上的增速。

| 指标 | 上次记录 | 最新数据 | 变化 |
|---|---|---|---|
| 总 Stars | 47,941 | 48,684 | +743 |
| 总 Forks | 7,417 | 7,486 | +69 |
| 今日新增 | — | 743 stars | — |

**核心变化**：
- Star 47,941 → 48,684（+743），Forks 7,417 → 7,486（+69）
- 连续第 3 日登上 Trending，持续保持 Trending 曝光
...
*首次分析：2026 年 4 月 | 最近更新：2026 年 9 月 9 日*
