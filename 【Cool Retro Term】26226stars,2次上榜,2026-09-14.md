...
- Cool Retro Term 连续第二天登上 GitHub Trending，总 Stars 达到 26,226。
- 这个创建于 2013 年的终端美学项目凭借 CRT 辉光/扫描线着色器特效持续吸引新一代开发者，「老项目回潮」现象的代表性样本。
- 今日新增 +104 与昨日 +98 基本持平，热度稳定而非爆发式，符合情怀型项目的传播特征。

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 26,122 | 26,226 | +104 |
| 总 Forks | 1,014 | 1,016 | +2 |
