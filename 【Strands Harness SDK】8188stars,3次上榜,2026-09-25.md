...
**最新动态**：连续第三天在榜，且今日增速明显加快：单日 +463 Stars（昨日 +161），是本次回榜以来最大单日增幅，总量突破 8,100。

作为 AWS Strands Agent 生态的 harness 基础设施，项目受益于 Agent SDK 标准化讨论的热度；仓库提交活跃，多 AI 编码代理配置目录（.agents/.claude/.kiro）持续同步演进。

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 7,759 | 8,188 | +429 |
| 总 Forks | 1,195 | 1,226 | +31 |

**核心变化**：

- Star 数：7,759 → **8,188**（+429）
- Forks：1,195 → 1,226（+31）
- 上榜情况：2026年9月25日
...
*首次分析：2026 年 9 月 | 最近更新：2026年9月25日*
