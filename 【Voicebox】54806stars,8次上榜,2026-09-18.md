...
Star 增长 197 颗，日增 412 颗（Trending）。The open-source AI voice studio. Clone, dictate, create.
...
### 更新 6 — 2026年9月16日（时隔 43 天再登 Trending）

**更新原因**：项目时隔一个多月再次登上 GitHub Trending 榜单，Star 数从 48,875 增长至 54,046（+5,171），日增 409 颗 Star，总星数突破 5.4 万。

**最新 Star 数据**：

| 总 Stars | 48,875 | 54,046 | +5,171 |
| 总 Forks | — | 6,771 | — |

- Star 数 48,875 → 54,046（+5,171），Fork 数达 6,771，稳居开源 AI 语音工作室赛道头部
- 作为 ElevenLabs + WisprFlow 的开源替代，7 引擎 TTS + 零样本克隆 + 全局听写 + MCP 语音输出的完整功能栈持续吸引开发者
- 基于 Tauri (Rust) 本地运行、隐私友好的架构定位未变

> 更新依据：GitHub Trending 2026-09-16 数据，Star 数由 GitHub API 实时获取

---

### 更新 7 — 2026年9月17日（连续第二日在榜）

**更新原因**：连续第二日在榜，Star 数从 54,046 增长至 54,323（+277），Fork 数从 6,771 增至 6,785（+14）。

**最新 Star 数据**：

| 总 Stars | 54,046 | 54,323 | +277 |
| 总 Forks | 6,771 | 6,785 | +14 |

- Star 数 54,046 → 54,323（+277），7 引擎 TTS + 零样本克隆功能栈热度延续
- 基于 Tauri (Rust) 本地运行的隐私友好定位持续吸引 ElevenLabs 替代需求

> 更新依据：GitHub Trending 2026-09-17 数据，Star 数由 GitHub API 实时获取

---

### 更新 8 — 2026年9月18日（连续第三日在榜）

**更新原因**：登上 GitHub Trending（2026 年 9 月 18 日），7 引擎 TTS热度延续。

**最新 Star 数据**：

| 总 Stars | 54,323 | 54,806 | +483 |
| 总 Forks | 6,785 | 6,821 | +36 |

- Star 数 54,323 → 54,806（+483），连续第三日在榜，本地语音克隆热度延续
- 基于 Tauri (Rust) 本地运行、隐私友好的 ElevenLabs 替代定位持续获关注
