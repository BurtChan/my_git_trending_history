...
### 更新 2 — 2026年8月6日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单，Star 数从 13,099 增长至 14,835（+1,736），日增 1,891 颗 Star

**最新动态**：TencentDB Agent Memory 作为腾讯云开源的团队级 AI Agent 记忆中枢，在 8 月初持续霸榜 Trending，48 小时内 Star 增长超 1,700。项目将对话、文档和代码转化为四种可复用记忆资产（Chat Memory、Skill、LLM-Wiki、Code-Graph），并强调「治理、共享、跨 Agent 与框架装备」的企业级记忆管理理念。随着各大 Agent 框架（Claude Code、Codex 等）对长期记忆与团队协作能力的需求爆发，该项目作为「团队级记忆」赛道的代表性开源实现，正吸引大量企业级开发者关注。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 13,099 | 14,835 | +1,736 |
| 总 Forks | 1,257 | 1,346 | +89 |

**核心变化概要**：
- Star 数 24 小时增长 +1,736，日增 1,891 颗（Trending），增速显著加快
- 团队级记忆中枢定位（区别于个人记忆工具），支持四种记忆资产跨 Agent 复用
- 腾讯云背书 + 企业治理能力（权限、审计、共享）是差异化优势
