...
### 更新 4 — 2026 年 9 月 3 日（再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单

**最新 Star 数据**：

| 总 Stars | 50,054 | 50,580 | +526 |
| 总 Forks | 3,508 | 3,553 | +45 |

**核心变化概要**：
- Star 数 50,054 → 50,580（+526），第 5 次登上 Trending
- Forks 3,508 → 3,553（+45），社区贡献持续活跃
- 距上次上榜（8 月 29 日）间隔 5 天，今日 +140 stars，热度回升
