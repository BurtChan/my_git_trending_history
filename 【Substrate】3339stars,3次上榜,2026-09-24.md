...
**更新原因**：Substrate 连续第三天登上 GitHub Trending，Star 数从 2,668 增长至 3,339（+671），Fork 数从 366 增长至 402（+36）。Google ax 开源带动的「沙箱内核」关注热度仍在延续。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|------|------|------|
| 总 Stars | 2,668 | 3,339 | +671 |
| 总 Forks | 366 | 404 | +38 |

- 回榜三日在榜累计增长约 +1,859，Star 总量较回榜前（1,480）已翻倍有余
- 与 google/ax 构成的「沙箱内核 + 编排层」组合持续被社区讨论，Agent Infra 赛道卡位清晰
- v0.1.0 首个正式版本（9 月 10 日）后保持高频推送，未关闭 Issue 513 个显示工程强度同步上升
...
*首次分析：2026 年 8 月 21 日 | 最近更新：2026 年 9 月 24 日*
