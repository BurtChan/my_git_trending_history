...
**更新原因**：项目再次登上 GitHub Trending 榜单（203 stars today）

**最新动态**：
- Agent Skills 自 7 月首次登上 Trending 后持续爆发式增长，Star 数从 72K 跃升至 81.8K（+9,643），一个月内增长近万颗
- Addy Osmani 持续扩充生产级工程技能库，覆盖规格驱动开发、质疑驱动审查、上下文工程等完整方法论
- 项目已成为 AI 编码代理生态中最具影响力的技能规范集合之一，被广泛集成到 Claude Code、Codex、Cursor 等主流工具

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 72,147 | 81,790 | +9,643 |
| 总 Forks | 7,815 | 8,808 | +993 |

**核心变化概要**：
1. Star 数从 72,147 增长至 81,790（+9,643），增长势头强劲
2. Forks 从 7,815 增至 8,808（+993），社区贡献者持续增加
3. 8 个斜杠命令 + 24 个完整技能构成的生产级技能库持续完善
...
**更新原因**：项目再次登上 GitHub Trending 榜单（588 stars today）

**最新动态**：
- Agent Skills 连续两日登上 Trending，Star 数从 8 月 5 日的 81.8K 增长至 82.4K（+573），持续保持高位稳定增长
- Addy Osmani 的生产级工程技能库继续作为 AI 编码代理生态的核心规范来源，被 Claude Code、Codex、Cursor 等主流工具广泛集成
- 8 个斜杠命令与 24 个完整技能构成的体系持续迭代，规格驱动开发、质疑驱动审查、上下文工程等方法论深入人心

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 81,790 | 82,363 | +573 |
| 总 Forks | 8,808 | 8,847 | +39 |

**核心变化概要**：
1. Star 数从 81,790 增长至 82,363（+573），连续两日上榜
2. Forks 从 8,808 增至 8,847（+39），社区贡献稳定
3. 作为 AI 编码工程技能的事实标准，项目影响力持续扩大




### 更新 3 — 2026 年 8 月 7 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单（588 stars today）

**最新动态**：
- Agent Skills 连续第三日登上 Trending，Star 数从 82,363 增长至 82,843（+480），持续保持高位稳定增长
- 由 Addy Osmani（Google Chrome 团队、Web 性能权威）主导的工程技能库持续扩充，覆盖规格驱动开发、质疑驱动审查等完整工程方法论，支持 Claude Code、Codex、Cursor 等多工具导入
- 作为「生产级工程技能」的事实标准之一，项目在 AI 编码代理质量标准化讨论中持续占据核心位置

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 82,363 | 82,843 | +480 |
| 总 Forks | 8,847 | 8,882 | +35 |

**核心变化概要**：
1. Star 数从 82,363 增长至 82,843（+480），连续三日上榜
...
### 更新 6 — 2026 年 8 月 10 日（再次登上 Trending）
**更新原因**：Agent Skills 连续第七日登上 GitHub Trending，Star 数从 84,405 增长至 85,017（+612），Forks 从 8,952 增至 9,149（+197），连续上榜天数创下本仓库最长纪录。

**最新动态**：Agent Skills 本周发布的最新版本带来两项社区呼声很高的改进：其一是新增「Source-driven Development」技能——一个框架无关的新技能，要求 Agent 在动手编码前以官方文档为基准，强制其引用来源、准确识别技术栈，并在编码前消解冲突信息，进一步补全了「先查证再编码」的工程纪律；其二是性能优化大改版，对技能加载与指令执行路径做了系统性优化，降低了对 agent 上下文窗口的占用。项目持续吸收社区贡献，skills 数量与覆盖的 agent 生态（Claude Code、Gemini CLI、Cursor、Codex、OpenCode 等）同步扩展。O'Reilly Radar 等媒体对「技能让工程纪律不可跳过」的理念持续传播，doubt-driven-development 等对抗式审查技能成为社区讨论焦点。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 84,405 | 85,017 | +612 |
| 总 Forks | 8,952 | 9,149 | +197 |

**核心变化概要**：
- Agent Skills 连续第七日登上 GitHub Trending，Star 数从 84,405 增长至 85,017（+612），Forks 从 8,952 增至 9,149（+197），连续上榜天数创下本仓库最长纪录。
...
### 更新 7 — 2026 年 8 月 11 日（再次登上 Trending）
**更新原因**：Agent Skills 连续第八日登上 GitHub Trending，Star 数从 85,017 增长至 85,659（+642），Forks 从 9,149 增至 9,223（+74），连续上榜天数继续刷新本仓库纪录。

**最新动态**：Agent Skills 项目持续迭代，0.6.x 版本线继续推进（最新 0.6.6 于约一周前发布）。社区呼声很高的 Source-driven Development 新技能（#45）持续获得关注——该框架无关技能要求 Agent 在动手编码前以官方文档为基准，强制引用来源、准确识别技术栈并消解冲突信息，进一步补全「先查证再编码」的工程纪律。性能优化大改版同步推进，对技能加载与指令执行路径做了系统性优化，降低对 agent 上下文窗口的占用。0.6.3 版本还强化了代码审查能力，新增两份参考 checklist 与诚实对比文档，并引入防止新技能重复建设的 guardrails；ADR 技能现在会自动检测并匹配既有 ADR 惯例（#402）。项目持续吸收社区贡献，skills 数量与覆盖的 agent 生态（Claude Code、Gemini CLI、Cursor、Codex、OpenCode 等）同步扩展。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 85,017 | 85,659 | +642 |
| 总 Forks | 9,149 | 9,223 | +74 |

**核心变化概要**：
- Agent Skills 连续第八日登上 GitHub Trending，Star 数从 85,017 增长至 85,659（+642）
- Source-driven Development 技能持续获得社区关注，0.6.x 版本线稳步推进
- 0.6.3 强化代码审查、新增参考 checklist 与防重复 guardrails
- ADR 技能自动检测既有惯例，社区贡献（#402、#407 等）持续合入
---

### 更新 8 — 2026 年 8 月 12 日（再次登上 Trending）

**更新原因**：Agent Skills 连续第九日登上 GitHub Trending，Star 数从 85,659 增长至 86,151（+492），Forks 从 9,223 增至 9,262（+39），连续上榜天数继续刷新本仓库纪录。

**最新动态**：Agent Skills 项目持续迭代，0.6.x 版本线继续推进。社区关注的 Source-driven Development 新技能（#45）持续获得关注——该框架无关技能要求 Agent 在动手编码前以官方文档为基准，强制引用来源、准确识别技术栈并消解冲突信息。性能优化大改版同步推进，对技能加载与指令执行路径做系统性优化，降低对 agent 上下文窗口的占用。代码审查能力持续强化，新增参考 checklist 与诚实对比文档，防止新技能重复建设的 guardrails 持续完善；ADR 技能自动检测并匹配既有 ADR 惯例。项目持续吸收社区贡献，skills 数量与覆盖的 agent 生态（Claude Code、Gemini CLI、Cursor、Codex、OpenCode 等）同步扩展。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 85,659 | 86,151 | +492 |
| 总 Forks | 9,223 | 9,262 | +39 |

**核心变化概要**：
- Star 数从 85,659 增长至 86,151（+492），连续第九日上榜
- Forks 从 9,223 增至 9,262（+39）
- 0.6.x 版本线推进，Source-driven Development 技能持续获关注
...
### 更新 10 — 2026 年 9 月 3 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单（280 stars today）

**最新动态**：
- 4 天内再次登上 Trending（第 11 次上榜），Star 数 90,691 → 91,837（+1,146），向 100K 里程碑稳步推进
- 本轮 Skills 生态热潮中与 anthropics/skills、mattpocock/skills、superpowers 同日霸榜，工程化技能库需求持续旺盛
- 由 Addy Osmani 主导的规格驱动开发、质疑驱动审查等传统软件工程方法论技能化集合，仍是 AI 编码质量标准化的代表项目

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 90,691 | 91,837 | +1,146 |
| 总 Forks | 9,706 | 9,799 | +93 |

**核心变化概要**：
- Star 增长 1,146，第 10 次登上 Trending，社区关注度保持高位
- Skills 生态整体爆发，多技能库项目同日上榜，赛道热度为年内高点
- 项目定位与内容策略不变，持续服务 AI 编码 Agent 工程化需求

---

### 更新 11 — 2026 年 9 月 15 日

**更新原因**：时隔 12 天再次登上 GitHub Trending（第 12 次上榜），单日 +354 Stars

Agent Skills 时隔 12 天第 12 次登上 Trending：总 Stars 从 91,837 增至 94,468（+2,631），Forks 从 9,799 增至 10,040，向 100K 里程碑推进。Skills 生态依然是 AI 编码工具链的投资热点，Addy Osmani 主导的工程化技能库（规格驱动开发、质疑驱动审查等）持续作为该赛道的代表性项目，与 anthropics/skills 等同场竞争但保持差异化定位。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 91,837 | 94,468 | +2,631 |
| 总 Forks | 9,799 | 10,040 | +241 |
| 今日新增 | — | +354 | — |

**核心变化概要**：
- 总 Stars 91,837 → 94,468（+2,631），距 100K 里程碑约 5.5K
- Forks 9,799 → 10,040（+241），突破 10K Forks
- 第 12 次上榜，Skills 生态长线热度不减
...
*首次分析：2026 年 7 月 | 最近更新：2026 年 9 月 15 日*
