...
- 连续第二天在榜，Star 数从 22,064 增至 22,333（+269）
- 头部基本信息表中的 Star/Fork 数据同步刷新

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 22,064 | 22,333 | +269 |
| 总 Forks | 2,857 | 2,858 | +1 |
| 今日新增 | — | 269 stars | — |

---

### 更新 4 — 2026 年 9 月 9 日（连续第三天登上 Trending（9/7-9/9））

**连续第三天在榜**，项目热度持续：

- Star 数从 22,333 增至 22,697（+364），Forks 增至 2,885（+27）
- 浏览器端 3D 建筑编辑器赛道持续吸引建筑与设计社区关注
- 头部基本信息表中的 Star/Fork 数据同步刷新

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 22,333 | 22,697 | +364 |
| 总 Forks | 2,858 | 2,885 | +27 |
| 今日新增 | — | 364 stars | — |


---

### 更新 5 — 2026 年 9 月 10 日（连续第四天登上 Trending（9/7-9/10））

**连续第四天在榜**（9/7-9/10），项目热度进入平台期但曝光持续：

- Star 从 22,697 增至 22,822（+125），Forks 增至 2,892（+7）
- 浏览器端 3D 建筑编辑器在连续四天 Trending 曝光后增速自然回落，但社区基本盘持续扩大
- 头部基本信息表中的 Star/Fork 数据同步刷新

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 22,697 | 22,822 | +125 |
| 总 Forks | 2,885 | 2,892 | +7 |
| 今日新增 | — | 125 stars | — |

---

### 更新 6 — 2026 年 9 月 11 日（连续第五天登上 Trending（9/7-9/11））

**连续第五天在榜**（9/7-9/11），热度从平台期再度回升：Star 数从 22,822 增至 23,290（+468），Forks 从 2,892 增至 2,918（+26）。作为开源 3D 建筑编辑器（BIM/CAD、参数化设计、楼层平面），其 React Three Fiber + Next.js 技术组合与 MCP 集成持续吸引开发者关注，23K Star 里程碑达成。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 22,822 | 23,290 | +468 |
| 总 Forks | 2,892 | 2,918 | +26 |
| 今日新增 | — | 468 stars | — |
...
### 更新 7 — 2026 年 9 月 12 日（连续第六天登上 Trending（9/7-9/12））

**更新原因**：连续 6 天登上 GitHub Trending（streak 特例，块链 9/7-9/11 + 今日在榜）

**最新动态**：
- Pascal Editor 是开源 3D 建筑编辑器，提供本地 CLI、MCP 工具与面向人类和 AI Agent 的实用工作流。
- 连续 6 天在榜，Star 增长进入平稳期（日增约 200），但社区粘性可观。
- 「面向 AI Agent 的编辑器」定位持续吸引关注。

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 23,290 | 23,494 | +204 |
| 总 Forks | 2,918 | 2,932 | +14 |
| 今日新增 | — | +204 | — |

**核心变化**：
- Star 23,290 → 23,494（+204），连续在榜第 6 天。
- Forks 2,918 → 2,932（+14）。
- 开放 Issue 数约 56。
