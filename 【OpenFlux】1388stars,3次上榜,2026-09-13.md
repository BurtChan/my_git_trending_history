...
连续第二天在榜，Star 从 919 增至 1,121（+202），「用文档光标消息传 TCP 流量」的话题热度仍在扩散

今日增量（+202）与昨日（+201）几乎持平，传播曲线未见衰减，对小体量研究型仓库相当罕见

最近推送 2026-09-11，GPL-3.0，仍标注 Educational use only——隐蔽信道研究的开源演示定位不变

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 919 | 1,121 | +202 |
| 总 Forks | 78 | 87 | +9 |
...
### 更新 2 — 2026 年 9 月 13 日（连续第三天登上 Trending）

**更新原因**：连续第三天登上 GitHub Trending（连续在榜 ≥3 天特例入选），单日 +267 Stars

**最新动态**：

- Star 1,121 → 1,388（+267），连续第三天在榜，三天累计约 +490，上升趋势保持。

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 1,121 | 1,388 | +267 |
| 总 Forks | 87 | 102 | +15 |
| 今日新增 | — | +267 | — |

**核心变化**：

- Forks 87 → 102（+15），Fork 增速与 Star 同步，开发者实际采用迹象明显。
