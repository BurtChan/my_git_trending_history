...
### 更新 3 — 2026 年 8 月 20 日（再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：oMLX 持续强化 Apple Silicon 本地大模型服务体验：连续批处理、内存与 SSD 分层 KV 缓存、多模型服务、OpenAI/Anthropic 兼容接口，以及菜单栏应用与 Web 管理面板形成完整闭环。DMG 自动更新、Homebrew、CLI shim 和 MCP 支持进一步降低了长期运行门槛。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 19,366 | 19,764 | +398 |
| 总 Forks | 1,668 | 1,685 | +17 |

**核心变化概要**：

- 连续第四次上榜，Stars 增至 19,764
- Forks 增至 1,685，本地推理部署生态继续扩张
- 分层 KV 缓存和菜单栏运维仍是相对普通 MLX 服务的核心优势
