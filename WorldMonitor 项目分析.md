...
**最新动态**：
WorldMonitor 持续巩固其全球态势感知平台的地位。数据聚合能力从最初的基础新闻和地图展示扩展到 65+ 供应商和 500+ 信息流的庞大规模，覆盖地缘政治、金融、能源、气候、航空、网络、军事和基础设施八大领域。双地图引擎（3D 地球仪和 WebGL 平面地图）支持 56 种图层类型，跨流关联分析能力让军事情报、经济信号、灾害预警和升级趋势一目了然。v2.5.23 版本的发布标志着该项目已成为开源情报领域最全面的一站式解决方案。
...
**核心变化概要**：
- 数据源大幅扩展至 65+ 外部供应商，500+ 精选信息流覆盖 35 个源组
- 发布 v2.5.23 版本，累计 43 个 Release 持续迭代
