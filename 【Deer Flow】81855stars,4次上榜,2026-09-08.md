...
| **Star 数** | 81,690（截至 2026 年 9 月 7 日） |
| **Fork 数** | 11,293 |
| **开源协议** | MIT License |
...
**最新动态**：Deer Flow 自 8 月 2 日更新以来 Star 数从 78,600 继续增长至 81,690（+3,090）。字节跳动团队主导的 Deep Research 开源框架持续迭代：2.0 版本的多智能体架构与 claude-to-deerflow 集成逐步成熟，官方网站 deerflow.tech 提供在线演示，生产部署支持多 Worker 模式。今日上榜（+188 stars），社区活跃度保持稳定。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 81,855 | 81,690 | +3,090 |
| 总 Forks | 10,735 | 11,283 | +548 |

**核心变化概要**：
- Star 数从 78.6K 增至 81.7K（+3,090），社区规模稳步扩大
- 多智能体 Deep Research 工作流与 2.0 架构持续打磨
- deerflow.tech 官网上线，降低试用门槛
- 多 Worker 生产部署模式（Postgres + Redis Stream Bridge）就绪

---

### 更新 3 — 2026 年 9 月 8 日（连续第二天登上 Trending（9/7-9/8））

**连续第二天登上 Trending（9/7-9/8）**，项目数据持续增长：

- 连续第二天在榜，Star 数从 81,690 增至 81,855（+165）
- 字节跳动开源的深度研究报告框架热度延续，社区对多智能体研究工作流的讨论持续

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 81,690 | 81,855 | +165 |
| 总 Forks | 11,291 | 11,293 | +2 |
| 今日新增 | — | 165 stars | — |
