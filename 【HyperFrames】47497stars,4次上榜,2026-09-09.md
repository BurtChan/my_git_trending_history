...
### 更新 1 — 2026 年 9 月 7 日（时隔约 5 个月再次登上 Trending）

**更新原因**：项目再次登上 GitHub Trending 榜单。

**最新动态**：HyperFrames 自 2026 年 6 月分析以来持续高热度增长，Star 数从约 3.0 万增长至 44,826。作为 HeyGen 开源的「HTML 原生视频生成框架」，其「网页即视频源代码」的理念已获得 tldraw、TanStack 等知名产品采用。frame.md 设计系统与 Agent Skills 的组合让 AI 编程助手可以直接生成可渲染为视频的 HTML，程序化视频（programmatic video）品类正在成型，HyperFrames 是目前该赛道的事实标杆。今日再度上榜（+220 stars）显示社区关注仍在持续累积。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 29,783 | 44,826 | +15,043 |
| 总 Forks | — | 4,270 | — |

**核心变化概要**：
- Star 数从约 3 万增至 44,826（+15,043，+50%），增长强劲
- 「程序化视频」品类获得社区认可，Agent Skills 视频创作工作流逐步落地
- tldraw、TanStack 等重量级采用者背书持续放大影响力
- Apache 2.0 开源策略不变，HeyGen 生态构建思路清晰

---

### 更新 2 — 2026 年 9 月 8 日（连续第二日登上 Trending）
**原因：连续第二天上榜，单日 +662 stars，日增较昨日（+220）明显加速。**


**最新动态**：
- Star 数从 44,826 增至 45,488（+662），Forks 从 4,270 增至 4,298（+28），涨速较昨日扩大约 3 倍
- 「程序化视频」概念持续发酵，frame.md 设计系统与 Agent Skills 的组合被越来越多 AI 编程工作流引用
- tldraw、TanStack 等采用者之外的第二批落地案例开始出现，社区模板库与示例生态扩大

**核心变化概要**：
- 单日 +662 stars，为本仓库回归 Trending 后单日最高增速
- Forks +28，模板与二次开发活跃度同步上升
- 连续在榜两日，验证程序化视频赛道热度非单日脉冲

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 44,826 | 45,488 | +662 |
| 总 Forks | 4,270 | 4,298 | +28 |


---

### 更新 3 — 2026 年 9 月 9 日（连续第三日登上 Trending）

**更新原因**：连续第三日登上 Trending，Star 45,488 → 47,497（+2,009，API 口径）

**最新动态**：
- Star 数从 45,488 增至 47,497（+2,009），日增较昨日（+662）扩大约 3 倍，Trending 页面单日增量达 +2,628，位居今日榜单前列
- Forks 从 4,298 增至 4,379（+81），模板与二次开发活跃度同步上升
- HeyGen「HTML 即视频」范式持续获得前端与 AI 社区认可，Agent Skills 集成让视频渲染进入智能体工作流

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 45,488 | 47,497 | +2,009 |
| 总 Forks | 4,298 | 4,379 | +81 |

**核心变化概要**：
- Star 增长 2,009，连续第三日在榜，涨速不降反升
- 累计逼近 5 万 Star，成为程序化视频生成赛道标杆
- Fork 持续增长，社区模板生态初步成形
...
*数据来源：GitHub 仓库 (heygen-com/hyperframes)，2026 年 9 月 7 日访问*
