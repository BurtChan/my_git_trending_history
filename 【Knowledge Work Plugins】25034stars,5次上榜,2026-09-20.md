...
### 更新 4 — 2026年9月20日（连续第四日在榜）

**更新原因**：连续第四日登上 GitHub Trending（第 5 次上榜），单日新增 181 Stars（API 精确数据），连续在榜豁免单日 500 阈值。

**最新动态**：Anthropic Knowledge Work Plugins 总 Stars 从 24,853 增至 25,034（+181），正式突破 25K 里程碑。Forks 从 2,967 增至 2,984（+17）。增速较前两日（+406/+318）有所回落，但连续四日在榜说明「文档写作 / 邮件 / 简报场景的 Claude 插件套件」的需求曲线依然坚挺。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 24,853 | 25,034 | +181 |
| 总 Forks | 2,967 | 2,984 | +17 |
| 今日新增 | — | +181 | — |

**核心变化**：
1. 总 Stars 突破 25K，从 24,853 增至 25,034（+181），连续四日在榜
2. Forks 从 2,967 增至 2,984（+17）
3. 增速较前两日回落（+406 → +318 → +181），进入稳定增长期
...
*首次分析：2026 年 5 月 28 日 | 最近更新：2026 年 9 月 20 日*
