...
### 更新 3 — 2026年9月27日（连续第四日登上 Trending）

**更新原因**：连续第四日登上 GitHub Trending（今日 +173 Stars，Trending 快照口径，API 限额已耗尽），第 4 次上榜。

**最新动态**：

- 0.47.0（9 月 23 日）发布后连续四日在榜，Star 4,041 → 4,645（四日累计 +604），关注持续
- NVFP4 W4A4 端到端教程（Qwen3.6-35B-A3B，vLLM 吞吐 1.30x）与 Nemotron 3 Ultra 官方 FP4 checkpoint 持续吸引推理优化人群
- 依赖与量化器修复持续合入，迭代节奏稳定；Fork 数据为 Trending 快照口径估算

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 4,472 | 4,645 | +173 |
| 总 Forks | 649 | 661 | +12 |

**核心变化概要**：
- Star {ds} → {ns}（{dsv}），Fork {df} → {nf}（{dfv}）
- 其余要点见上方核心变化

> 更新依据：GitHub API 2026-09-27 数据（Trending 快照口径）
