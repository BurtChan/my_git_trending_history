...
### 更新 10 — 2026 年 9 月 26 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单，今日单日新增 +409 Stars

**最新动态**：
- Star 从 33,141 增长至 37,696（+4,555），近一个月增长约 13.7%，第 10 次登上 Trending
- Fork 从 4,498 增至 5,240（+742），Open Issues 仅 22，项目维护质量稳定
- 安全研究 × AI 技能包双赛道热度延续，逆向工程/渗透测试技能路由持续扩充

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 33,141 | 37,696 | +4,555 |
| 总 Forks | 4,498 | 5,240 | +742 |

**核心变化概要**：
- Star +4,555，Fork +742，第 10 次登上 Trending
- 今日单日 +409 星
- AI 安全研究技能包需求持续旺盛
