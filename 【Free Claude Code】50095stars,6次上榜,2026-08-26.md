...
### 更新 5 — 2026 年 8 月 25 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：Free Claude Code 持续在榜，Star 单日再增 1,057（47,717 → 48,774），Fork 从 7,852 增至 7,975（+123）。作为 Claude Code 免费替代接入方案的代表项目，其增长与 Claude Code 生态热度高度联动，逼近 49K。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 47,717 | 48,774 | +1,057 |
| 总 Forks | 7,852 | 7,975 | +123 |

**核心变化概要**：
- Star 增至 48,774（+1,057），与 Claude Code 生态热度联动增长
- Fork 增至 7,975，主表 Fork 数据本次一并修正（原 ~740 为早期估算残留）
- 主表 Star/Fork/今日新增三项全部由估算值修正为精确值

---

### 更新 6 — 2026 年 8 月 26 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：Free Claude Code 连续多日在榜，Star 突破 5 万大关（48,774 → 50,095，+1,321），Fork 从 7,975 增至 8,130（+155）。零成本使用 Claude Code 的需求持续旺盛，项目稳居 5 万 Star 俱乐部，增长动能不减。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 48,774 | 50,095 | +1,321 |
| 总 Forks | 7,975 | 8,130 | +155 |

**核心变化概要**：
- Star 突破 50,000（+1,321），持续与 Claude Code 生态热度联动
- Fork 增至 8,130，社区二次开发活跃
- 主表 Star/Fork/今日新增三项同步更新
