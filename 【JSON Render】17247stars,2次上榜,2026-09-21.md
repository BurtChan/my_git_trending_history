...
**更新原因**：连续第二日登上 GitHub Trending，Star 数增长 16,941 → 17,247（+306），突破 17K 里程碑。

**最新动态**：项目作为 Vercel「JSON Spec 受约束生成式 UI」方案的关注度持续攀升，两日合计 +891。今日 +306 增速较昨日（+585）有所回落但量级可观，多框架渲染器矩阵（React/Vue/Svelte/Solid）与 Remotion 视频生成示例继续是主要引流点。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 16,941 | 17,247 | +306 |
| Forks | 904 | 915 | +11 |
| 今日新增 | +585 | +306 | — |

**核心变化**：
- Star 突破 17,000，两日合计 +891
- Fork 数增至 915，社区基于渲染器做二次开发的活跃度提升
- 连续在榜确立其 AI 生成式 UI 基础设施的热点地位
