...
**最新动态**：Chatwoot 持续迭代，近期推出了语音通话功能（6 月）和更智能的对话分配策略（3 月）。v4.11 版本引入结构化解决方案工作流、Captain AI 辅助回复编辑器改进，以及对话处理 UX 优化。该项目作为开源客户参与平台，支持 WhatsApp、Instagram、邮件等多渠道，持续在 Trending 上保持活跃。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 35,026 | 35,143 | +117 |
| 总 Forks | 8,435 | 8,435 | — |

**核心变化概要**：
- v4.11 引入结构化解决方案工作流和 Captain AI 增强
- 新增语音通话功能，填补关键通信渠道
- 智能对话分配策略优化团队效率
- 开源客户参与平台地位稳固
