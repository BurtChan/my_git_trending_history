...
### 更新 1 — 2026年9月18日（时隔约 5 个月再次登上 Trending）

**更新原因**：时隔约 5 个月再次登上 GitHub Trending 榜单。

**最新动态**：RustFS 总 Star 从 25,222 增至 32,909（+7,687，约 +30%），Fork 从 1,072 增至 1,475。项目进入 1.0 稳定版最后冲刺：9 月 16-18 日三天连续发布 1.0.1-preview.1/3/5 预览版，修复节奏极快，正式 1.0 发布在即。作为 Rust 编写的高性能对象存储（对标 MinIO，Apache 2.0 许可证规避 AGPL 商业限制），其在云原生存储赛道的关注度持续攀升。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 25,222 | 32,909 | +7,687 |
| 总 Forks | 1,072 | 1,475 | +403 |

**核心变化概要**：
- Star 增长 30%，接近 3.3 万
- 1.0.1-preview 三连发，正式 1.0 在即
- Rust 对象存储赛道热度持续，MinIO AGPL 替代需求明确
...
*数据来源：GitHub 仓库 (rustfs/rustfs)，2026 年 9 月访问*
