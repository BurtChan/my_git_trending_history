...
**上榜原因**：连续第二日登上 Trending（昨日 +325、今日 +325 增速持平），Star 总数突破 4,800。

**最新动态**：Higgsfield 本身仓库无新版本发布（最近 release 仍为 2024 年的 v0.0.4-rc），本轮热度主要由产品侧驱动——其 AI 视频生成平台在社交媒体持续发酵，带动 GitHub 仓库关注度上升。今日 Trending 增量 +325 与昨日持平，说明热度尚未衰退。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|---------|---------|------|
| 总 Stars | 4,660 | 4,869 | +209 |
| 总 Forks | 869 | 899 | +30 |

**核心变化**：
- 仓库代码本身无实质更新，增长完全来自产品热度外溢
- Open Issues 维持 13 个低位，社区互动以产品讨论为主
- 增速连续两日 +300 量级，若持续将进入快速上升通道

---

### 更新 2 — 2026 年 9 月 21 日（连续第三日在榜）

**更新原因**：连续第三日登上 Trending，Star 数从 4,869 增长至 5,280（+411），增速较昨日（+209）接近翻倍，进入快速上升通道。

**最新 Star 数据**：

| 总 Stars | 4,869 | 5,280 | +411 |
| 总 Forks | 899 | 945 | +46 |

- Star 数 4,869 → 5,280（+411），连续在榜第三日，日均增量从 +209 攀升至 +411
- 今日 Trending 页面显示 +461 stars today，热度仍在加速
- 仓库无新版发布（最新 release 仍为 2024 年 3 月的 v0.0.4-rc），增长完全由社区自发传播驱动
