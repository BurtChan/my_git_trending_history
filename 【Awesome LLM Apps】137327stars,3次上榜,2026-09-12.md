...
- Awesome LLM Apps 时隔一个多月再次登上 Trending（+161 stars today）。Star 从 7 月 12 日的 118,291 增长至 134,018（+15,727），Fork 从 17,597 增至 19,722（+2,125），六周内增长超 13%。
- 作为收录 RAG/Agent/Chatbot 等 LLM 应用示例的最大合集之一（同作者 Shubhamsaboo 的 AgentVerse/awesome-ai-agents 系），项目持续跟进 2026 年主流模型与框架的示例更新，仓库最近推送于 8 月 22 日，维护活跃。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 118,291 | 134,018 | +15,727 |
| 总 Forks | 17,597 | 19,722 | +2,125 |

**核心变化概要**：

- 时隔六周再上榜，Star +15,727 至 134,018
- Fork +2,125 至 19,722，示例合集被大量复用
- 仓库 8 月 22 日仍有推送，维护活跃

---

### 更新 2 — 2026 年 9 月 12 日（再次登上 Trending）

两周后再次登上 Trending，Star 从 134,018 增长至 137,327（+3,309），Fork 从 19,722 增至 20,208。作为覆盖 100+ AI Agent、Agent Skills 与 RAG 应用的模板合集，其 Apache-2.0 许可下的免费开源模式持续吸引大量开发者复用示例，本期上榜单日新增 237 Star，热度依旧稳固。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 134,018 | 137,327 | +3,309 |
| 总 Forks | 19,722 | 20,208 | +486 |

**核心变化概要**：

- Star +3,309 至 137,327，两周增长约 2.5%
- Fork +486，模板复用活跃度保持高位
- 100+ Agent/RAG 模板合集的生态位持续巩固
