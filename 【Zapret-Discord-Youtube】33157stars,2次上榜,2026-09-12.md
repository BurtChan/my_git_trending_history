...
时隔四个多月再次登上 Trending，Star 从 26,874 增长至 33,157（+6,283），Fork 从 2,100 增至 2,536。项目在俄罗斯封锁持续加码的背景下保持稳定更新，仍是当地用户绕过 Discord/YouTube/Instagram/Telegram 封锁的首选工具之一。本期上榜单日新增 52 Star，热度进入长尾稳定期但社区基本盘持续扩大。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 26,874 | 33,157 | +6,283 |
| 总 Forks | 2,100 | 2,536 | +436 |

**核心变化概要**：

- Star +6,283 至 33,157，四个多月增长约 23%
- Fork +436，Windows DPI 绕过方案仍是刚需
- 单日新增 52 Star，进入稳定增长期
