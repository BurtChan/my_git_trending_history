...
### 更新 2 — 2026年8月23日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单

**最新动态**：TypeScript 连续第二天上榜，Star 从 110,363 微增至 110,607（+244），单日增量 104。编译器 Go 原生化（tsgo）迁移持续推进，主仓语言标注维持 Go；7.0 路线图聚焦性能与工具链现代化的叙事仍是上榜主因。作为 2480 万项目使用的事实标准语言，短期 Star 波动意义不大，里程碑式事件（如 tsgo 稳定版发布）才是增速拐点。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 110,363 | 110,607 | +244 |
| 总 Forks | 13,740 | 13,748 | +8 |

**核心变化概要**：
- Star 增长 +244，连续 2 天上榜
- tsgo（Go 原生编译器）迁移叙事持续吸引关注
- 巨大体量下增速平稳，关注 7.0 里程碑节点
