...
**最新动态**：
- 隐私优先的语音转文字听写应用，本地模型（Nvidia Parakeet/Whisper）与云端 BYOK 模式并行支持，跨平台可用
- Star 数从 7,109 增长至 7,369（+260），Forks 从 924 增至 931（+7）
- 今日再度登上 Trending（今日 +274），连续第二日保持增长势头

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 7,109 | 7,369 | +260 |
| 总 Forks | 924 | 931 | +7 |

**核心变化概要**：
- 连续第二日在榜，Star 稳定增长（+260），社区关注度持续
