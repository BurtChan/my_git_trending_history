...
**更新原因**：项目再次登上 GitHub Trending 榜单（33 stars today）

**最新动态**：
- Star 数从 18.3K 增长至 23.8K，增长约 30%，Compound Engineering 方法论持续获得关注
- 作为 Claude Code、Codex、Cursor 的官方插件，项目在 AI 编程工具生态中的地位稳固

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 18,300 | 23,771 | +5,471 |
| 总 Forks | 1,800 | 1,944 | +144 |
