...
### 更新 4 — 2026 年 9 月 15 日（连续第四日在榜）

连续第四天登上 Trending，Star 从 65,900 增长至 66,581（+681），Fork 增至 10,852。作为覆盖几乎所有主流 AI 厂商系统提示词的 CC0 透明度仓库，其连续在榜节奏与各家新模型发布周期同频——最新一代产品的提示词数据持续吸引 Prompt Engineering 与 AI 安全研究者的引用，单日增速较昨日（+400）回升，发酵期仍在延续。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Star | 65,900 | 66,581 | +681 |
| Fork | 10,789 | 10,852 | +63 |
| 今日新增 | — | +770 | — |

**核心变化概要**：

- Star +681 至 66,581，连续四日在榜
- Fork +63 至 10,852
- 上榜单日 +770，透明度议题热度回升
