...
### 更新 2 — 2026 年 9 月 13 日（连续第二日在榜）

连续第二天登上 Trending，Star 从 64,972 增长至 65,500（+528），Fork 从 10,681 增至 10,752（+71）。昨日分析中提到的覆盖范围扩展（GPT-6-Astra、Gemini 3.8 Flash、Claude Fable 5.1 等最新一代模型）继续吸引社区关注，单日 +528 Star 的增速较昨日（+216）明显加快，说明该透明度仓库正处于持续发酵期，社区对 AI 系统提示词透明度的关注度仍在上升。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Star | 64,972 | 65,500 | +528 |
| Fork | 10,681 | 10,752 | +71 |

**核心变化概要**：

- Star +528 至 65,500，连续两日在榜持续增长
- Fork +71 至 10,752，社区复制与二次分析热度延续
- 单日增速较昨日（+216）翻倍以上，透明度议题热度上升


---

### 更新 3 — 2026 年 9 月 14 日（连续第三日在榜）

连续第三天登上 Trending，Star 从 65,500 增长至 65,900（+400），Fork 增至 10,766。作为覆盖几乎所有主流 AI 厂商系统提示词的 CC0 透明度仓库，其连续在榜的节奏与各家新模型发布周期同频——覆盖 GPT-6-Astra、Gemini 3.8 Flash、Claude Fable 5.1 等最新一代产品的数据持续吸引 Prompt Engineering 与 AI 安全研究者的引用，单日 +400 的增速表明发酵期仍在延续。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Star | 65,500 | 65,900 | +400 |
| Fork | 10,752 | 10,789 | +37 |
| 今日新增 | — | +727 | — |

**核心变化概要**：

- Star +400 至 65,900，连续三日在榜
- Fork +37 至 10,789，二次分析热度延续
- 上榜单日 +727，透明度议题仍是社区焦点
