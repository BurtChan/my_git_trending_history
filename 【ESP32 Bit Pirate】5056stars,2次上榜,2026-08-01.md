...
**最新动态**：
- v1.6 版本发布，新增 Pirate Assistant 内置帮助系统至 WebUI
- 新增 WiFi 热点模式，设备可自行创建热点，无需现有网络即可通过手机或电脑访问 Web CLI
- 独立终端模式改进：支持方向键滚动、Tab 命令历史
- Sub-GHz 协议改进：新增 RSSI 到音频映射、捕获和重放可靠性提升
- UART 嗅探和自动波特率检测优化，I2C 新增寄存器追踪和更安全的寄存器操作
- 持续扩展硬件支持，新增 M5 Cardputer ADV、M5 StampS3 等设备配置
- LinuxGizmos 专题报道了 WiFi 热点和 Pirate Assistant 等新功能

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 4,712 | 5,056 | +344 |
| 总 Forks | 396 | 396 | — |

**核心变化概要**：
- WiFi 热点模式让设备真正实现无网络环境下的便携使用
- Pirate Assistant 内置帮助系统降低上手门槛
- 协议层面的持续改进提升了专业可用性
