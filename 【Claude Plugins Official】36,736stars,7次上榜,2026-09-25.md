...
**更新原因**：项目连续第五日登上 Trending 榜单（8 月 26-30 日），今日新增 +356 Stars

**最新动态**：Claude Plugins Official 连续第五日登上 Trending，总 Star 数从 34,957 增长至 35,316（+359），Fork 数从 3,933 增至 3,957（+24）。官方插件目录保持每日数百量级的稳定增长，LSP 支持、代码审查、安全审计等 50+ 官方插件的收录管道持续高频自动同步，插件生态正成为 Claude 系产品对抗 Cursor 等对手的核心武器。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 34,957 | 35,316 | +359 |
| 总 Forks | 3,933 | 3,957 | +24 |

**核心变化概要**：
- 连续第五日在榜，总 Star 达 35,316（+359）
- Fork 数 3,957（+24）
- 官方插件生态持续扩容，增速平稳

### 更新 6 — 2026 年 9 月 25 日（时隔 26 天再次登上 Trending）

**更新原因**：时隔 26 天再次登上 Trending（上次在榜 8 月 30 日），Star 35,316 → 36,736（+1,420，API 口径）

**最新动态**：
- Claude Plugins Official 时隔 26 天重回 Trending，Star 从 35,316 增长至 36,736（+1,420），Forks 从 3,957 增至 4,147（+190）。
- 官方插件目录保持高频自动同步，LSP 支持、代码审查、安全审计等 50+ 官方插件持续扩容；插件生态已成为 Claude 系产品对抗 Cursor 等对手的核心武器，近 3.7 万 Star 验证其基础设施地位。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 35,316 | 36,736 | +1,420 |
| 总 Forks | 3,957 | 4,147 | +190 |

**核心变化概要**：
- Star 35,316 → 36,736（+1,420）
- Forks 3,957 → 4,147（+190）
- 50+ 官方插件持续扩容，收录管道高频自动同步
