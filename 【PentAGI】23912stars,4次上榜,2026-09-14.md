...
时隔两个月再次登上 Trending，Star 从 19,194 增长至 23,046（+3,852），Fork 从 2,607 增至 3,034。项目描述保持「全自主 AI Agent 系统执行复杂渗透测试任务」的定位，Go 语言实现的 13 Agent 协同架构在安全社区持续获得认可。本期上榜单日新增 250 Star，为今日安全类项目中表现最佳之一。

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 19,194 | 23,046 | +3,852 |
| 总 Forks | 2,607 | 3,034 | +427 |

**核心变化概要**：

- Star +3,852 至 23,046，两个月增长约 20%
- Fork +427，自动化渗透测试平台需求旺盛
- 与 Claude-Red 等技能库同期上榜，AI 安全攻防赛道整体火热

### 更新 2 — 2026 年 9 月 13 日

**更新原因**：连续第二日登上 GitHub Trending，单日 +611 Stars

**最新动态**：
PentAGI 连续第二日在榜：总 Stars 从 23,046 增至 23,657（+611），Forks 从 3,034 增至 3,078。作为 13 Agent 协同的全自主渗透测试平台，其 Go 实现 + 四层记忆系统 + 生产级基础设施的组合在安全社区持续获得认可，与 Claude-Red 等安全技能库同期在榜，AI 安全攻防赛道热度不减。

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|---|---|---|---|
| 总 Stars | 23,046 | 23,657 | +611 |
| 总 Forks | 3,034 | 3,078 | +44 |
| 今日新增 | — | +189 | — |


**核心变化概要**：
- 总 Stars 23,046 → 23,657（+611）
- Forks 3,034 → 3,078（+44）
- 连续第二日在榜，AI 渗透测试赛道火热

### 更新 3 — 2026 年 9 月 14 日（连续第三天登上 Trending）

**更新原因**：连续第三日登上 GitHub Trending（块链：9/12 → 9/13 → 9/14，连续在榜 ≥3 天特例入选），单日 +255 Stars

PentAGI 连续第三日在榜：总 Stars 从 23,657 增至 23,912（+255），Forks 从 3,078 增至 3,094（+16）。作为 13 Agent 协同的全自主渗透测试平台，AI 安全攻防赛道热度延续——同期在榜的 Claude-Red（安全技能库）也持续走高，「AI for Security」与「Security for AI」双向需求共振是本轮行情的主线。

**Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 23,657 | 23,912 | +255 |
| 总 Forks | 3,078 | 3,094 | +16 |
| 开放 Issues | — | 62 | — |

**核心变化概要**：
- 总 Stars 23,657 → 23,912（+255），连续第三日在榜
- Forks 3,078 → 3,094（+16）
- 开放 Issues 62 个，社区反馈稳定
