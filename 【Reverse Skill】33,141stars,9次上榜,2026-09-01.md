...
### 更新 8 — 2026 年 8 月 31 日（再次登上 Trending）
**更新原因**：时隔 26 天再次登上 GitHub Trending 榜单，Star 数从 17,462 增长至 32,597（+15,134，涨幅约 87%），日增 1,439 颗 Star

**最新动态**：
- 逆向工程/渗透测试/安全研究 AI 技能路由包在本月持续走高，Star 总量突破 3.2 万，接近翻倍
- 作为 AI 自动路由 + 按需自举工具链 + 自动进化经验库的技能包，对 Claude Code/Kiro/Cursor/Cline 等 AI 编程客户端的适配持续完善，PowerShell 为主的实现降低 Windows 安全研究环境的使用门槛
- 8 月下旬安全研究类 AI 工具整体热度上行，叠加技能包（Skills）生态的爆发，项目连续多日出现在 Trending 页面

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 17,462 | 32,597 | +15,135 |
| 总 Forks | 2,510 | 4,404 | +1,894 |

**核心变化概要**：
- Star +15,134（+87%），Fork +1,894，8 次上榜
- Star 总量突破 3.2 万，月内接近翻倍
- 安全研究 × AI 技能包双赛道红利叠加

---

### 更新 9 — 2026 年 9 月 1 日（再次登上 Trending）
**更新原因**：项目再次登上 GitHub Trending 榜单，今日单日新增 1,401 星，位列榜单热度前列

**最新动态**：
- Star 总量突破 3.3 万（32,597 → 33,141），自 8 月初以来累计增长已接近 3 倍，增长曲线仍未放缓
- 今日 Trending 单日热度 1,401 星，在本批榜单中高居第三，安全研究 × AI 技能包双赛道热度持续兑现
- 第 9 次登上 Trending，是 8 月以来最长青的技能类项目之一

**最新 Star 数据**：

| 指标 | 上次记录 | 最新数据 | 变化 |
|------|----------|----------|------|
| 总 Stars | 32,597 | 33,141 | +544 |
| 总 Forks | 4,404 | 4,498 | +94 |

**核心变化概要**：
- Star +544，Fork +94，第 9 次登上 Trending
- 今日单日热度 1,401 星，位列榜单前三
- 安全逆向工程技能包需求持续旺盛
